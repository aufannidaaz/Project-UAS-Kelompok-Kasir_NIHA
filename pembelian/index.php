                    ...
                    <div class="col-lg-6">
                        <div class="card card-outline card-warning p-3">
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="noBeli" class="form-control" id="noBeli" value="<?= $noBeli ?>">
                                </div>
...
<script>
    ...
    pilihbrg.addEventListener('change', function() {
        document.location.href = this.option[this.selectedIndex].value;
    })
