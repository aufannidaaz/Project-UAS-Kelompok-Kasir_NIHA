      ...
      <div class="card">
        <form action="" method="post" enctype="multipart/form-data">
          ...
          <div class="card-header">
            <h3 class="card-title"><i class="fas fa-pen fa-sm"> <?= $msg != '' ? 'Edit Barang' : 'Input Barang' ?></i>
            </h3>
            ...
            <div class="row">
              <div class="col-lg-8 mb-3 pr-3">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="name" class="form-control" id="name" placeholder="nama barang" value="<?= $msg != '' ? $barang['nama_barang'] : generateId() ?>" autocomplete="off" autofocus required>
                </div>
                <div class="form-group">
                  <label for="name">Nama</label>
                    ...
                    if ($msg != "") {
                      ...
                      foreach ($satuan as $sat) {
                        if ($barang['satuan'] == $sat) { ?>
                          <option value="<?= $sat ?>" selected><?php $sat ?></option>
                        <?php } else { ?>
                          <option value="<?= $sat ?>"><?php $sat ?></option>
                      <?php
                        }
                      }
                    } else { ?>
              ...
              <div class="col-4 text-center px-5">
                ...
                <img src="<?= $main_url ?>asset/image/<?= $msg != '' ? $barang['gambar'] : 'default.jpeg' ?>" class="profile-user-img mb-3 mt-4" alt="">
                <input type="file" name="image" class="form-control">
                <small class="text-secondary">Type file gambar JPG | PNG | GIF</small>
              </div>
            </div>
          </div>
        </form>
