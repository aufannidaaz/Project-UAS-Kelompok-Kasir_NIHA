...
if (isset($_POST['login'])) {
  ...
  $queryLogin = mysqli_query($koneksi, "SELECT * FROM tbl_user
...
<head>
  ...
  <title>Login | codingline POS</title>

  <!-- Google Font: Source Sans Pro -->
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="<?= $main_url ?>asset/AdminLTE-3.2.0/plugins/
  ...
  <div class="login-box slide-down" style="margin-top: -70px;">
    ...
    <div class="card card-outline card-primary">
      <div class="card-header text-center">
        <a href="#" class="h1"><b>Kasir</b>NIHA</a>
      </div>
      <div class="card-body">
        ...
        <form action="" method="post">
          ...
          <div class="mb-4">
            ...
            btn-primary btn-block">Sign In</button>
          </div>
          <!-- /.col -->
        </form>

        <p class="my-3 text-center">
          <strong>Copyright &copy; 2024 <span class="text-info">Hania & Nida</span></strong>
        </p>
      </div>
      <!-- /.card-body -->
    </div>
